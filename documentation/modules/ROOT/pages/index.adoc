...
* Create a {product-connectors-short} instance as a data source.
* Create a {product-connectors-short} instance as a data sink.
* Create a {product-connectors-short} instance to capture data change events from a cloud database.
...
* xref:01-provision-kafka-instance.adoc#configure_kafka[Configure the instance of {product-kafka} for use with {product-long-connectors}]
